...
@section ("contenido")
    ...
    <form action="{{route('detalleAl.store')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <a href="{{route('detalleAl.index')}}" class="btn btn-secondary">Cancelar</a>
            <a href="{{ route('detalleAl.massCreate') }}" class="btn btn-warning">Llenar Detalles</a>
        </div>
    </form>
@endsection

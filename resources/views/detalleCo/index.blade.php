...
<title>Botón con Ícono - Bootstrap</title>
    ...
    <a href="{{route('detalleCo.create')}}" class="btn btn-primary"> Crear +</a>
            ...
            @foreach($detalleCs as $detalleC)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{route('detalleCo.destroy', [$detalleC->id_compra, $detalleC->idDal])}}" method="POST">
                                @CSRF
                                @method('delete')
                                <a href="{{route('detalleCo.edit', [$detalleC->id_compra, $detalleC->idDal])}}" class="btn btn-info">Editar</a>

...
@section ("contenido")
    ...
    <h2 style= "font-size: 5rem; font-family:'Times New Roman', Times, serif" class="text-center" >Editar Datos De Detalle De Las Compra</h2>
    <form action="{{route('detalleCo.update', $detalleCo->id_detalleCo)}}" method="POST">
        @method('PUT')
        <!-- CSRF Token (Laravel) -->
        ...
        <div class="mb-3">
            ...
            <a href="{{route('detalleCo.index')}}" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
@endsection

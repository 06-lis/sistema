            ...
            @foreach($detalleVs as $detalleV)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/detalleVe/{{$detalleV->idDv}}/{{$detalleV->idDal}}/eliminar" method="POST">
                                @CSRF
                                @method('delete')
                                <a href="/detalleVe/{{$detalleV->idDv}}/{{$detalleV->idDal}}/editar" class="btn btn-info">Editar</a>
